...
export function MainScreen({ series, profile, onStart, onOpenVideo, onMenu, onJump, onReset, contentUp, breaks }) {
  ...
  return (
    <View style={styles.mainScreen}>
      <DebugJump onJump={onJump} onTab={onMenu} onReset={onReset} contentUp={contentUp} breaks={breaks} />
