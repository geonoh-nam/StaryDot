...
6. **전달문은 사건이 아니다.** "누가 …라고 말했다 / 밝혔다 / 전했다 / 알려 주었다" 는
   말이 오간 것이지 일이 일어난 것이 아니다. 뉴스·안내·설명도 마찬가지다.
   되물을 거리가 없으므로 뽑지 마라. 단, 그 말 **때문에** 인물이 무언가를 하거나
   느꼈다면 그 행동·감정 쪽을 사건으로 잡아라.
...
| `발견` | 인물이 몰랐던 것을 알아냈다 — **누가 말해 준 것은 제외**(6번 규칙) | 브레드가 이름이 비슷한 이발소를 찾아냈다 |
