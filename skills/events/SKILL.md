...
6. **이야기 밖에서 오는 정보는 사건이 아니다.** 뉴스 보도, 안내 방송, 해설자의 설명처럼
   **인물에게 일어난 일이 아니라 상황만 알려 주는 것**은 뽑지 마라. 되물을 거리가 없다.
   **인물이 인물에게 한 말은 사건이 될 수 있다** — 비밀을 털어놓거나, 부탁하거나,
   거절하거나, 몰랐던 사실을 알려 준 것은 그 자체로 이야기를 움직인 일이다.
   판별 기준은 하나다: **그 말 때문에 이야기가 달라졌는가.** 지나가는 잡담은 아니다.

7. **자신 없으면 만들지 마라.** 억지로 채운 10개보다 확실한 3개가 낫다.
...
| `발견` | 인물이 몰랐던 것을 알아냈다 — 스스로 찾아냈든 누가 알려 줬든 | 브레드가 이름이 비슷한 이발소를 찾아냈다 |
